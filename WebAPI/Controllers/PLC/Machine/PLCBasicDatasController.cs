...
namespace WebAPI.Controllers.PLC.Machine
{
    ...
    public class PLCBasicDatasController : ControllerBase
    {
        ...
        [HttpGet("readMachineLengthTotal")]
        public async Task<IActionResult> ReadMachineLengthTotal()
        {
            var dataResult = await _plcBasicDataService.ReadMachineLengthTotal();
            if (dataResult.Success)
            {
                return Ok(dataResult);
            }
        ...
        [HttpPost("writeMachineLengthTotal")]
        public async Task<IActionResult> WriteMachineLengthTotal(long machineLengthTotal)
        {
            var result = await _plcBasicDataService.WriteMachineLengthTotal(machineLengthTotal);
            if (result.Success)
            {
                return Ok(result);
            }
