...
using Entities.Concrete.Enums.General.Machine;
using System;
...
namespace Entities.Concrete.Entities.General.Machine
{
    public class EntryCoil : IEntity
    {
        ...
        public PositionStepTypeEnum? PositionStepType { get; set; }//Psi daki step ismi(FROLL,CROLL)
        ...
        public decimal? ThicknessAim { get; set; }//Kalınlık amaç
        ...
        public EntrySpoolTypeEnum? EntrySpoolType { get; set; }//Giriş kor var yada yok bilgisi  1 veye 0 gidecek
        public int? ExitSpoolInnerDiameter { get; set; }//INNER_DIA_OUT→çıkış kor çapı
        public ExitSpoolTypeEnum? ExitSpoolType { get; set; }//SPOOL_TYP_OUT→çıkış kor tipi
