...
namespace Entities.Concrete.Entities.General.Machine
{
    public class ExitCoil : IEntity
    {
        ...
        public int SpoolType { get; set; }//SpoolType (Kor Bilgisi):Üretim bittiğinde,üretim bildirim ekranında Spool Type Selection diye bir ekran olacak.Operatör hangi masurayı kullandı ise buradan masura numarasını seçecek.
        ...
        public decimal ThicknessInspectionTop { get; set; }//Inspection da ölçülen  üst kalınlık bilgisi:Operatör tarafından ölçülen değer,üretim bildirim ekranına girilecek (mm)
        public decimal ThicknessInspectionBottom { get; set; }//Inspection da ölçülen  alt  kalınlık bilgisi,üretim bildirim ekranına girilecek (mm)
        ...
        public long ContactRollTwoTwoDiameter { get; set; }//CONTACT_ROLL22 çap değeri  (mm)
        public long ContactRollTwoThreeDiameter { get; set; }//CONTACT_ROLL23 çap değeri (mm)
