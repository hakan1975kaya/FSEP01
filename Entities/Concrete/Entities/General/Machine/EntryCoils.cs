...
namespace Entities.Concrete.Entities.General.Machine
{
    public class EntryCoil : IEntity
    {
        ...
        public int? PositionStepType { get; set; }//Psi daki step ismi(FROLL,CROLL)
        ...
        public int? EntrySpoolType { get; set; }//Giriş kor var yada yok bilgisi  1 veye 0 gidecek
        public int? ExitSpoolInnerDiameter { get; set; }//INNER_DIA_OUT→çıkış kor çapı
        public int? ExitSpoolType { get; set; }//SPOOL_TYP_OUT→çıkış kor tipi
