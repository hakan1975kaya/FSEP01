...
namespace Business.Abstract.PLC.OutputCoils
{
    public interface IPLCOutputCoilOtherService
    {
        ...
        public Task<IResult> WriteLiftOneSetPositionSi(decimal liftOneSetPositionSi);
        ...
        public Task<IResult> WriteLiftOneSetPositionEighe(decimal liftOneSetPositionEigh);
