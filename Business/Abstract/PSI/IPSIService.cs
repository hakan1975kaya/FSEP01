...
namespace Business.Abstract.PSI
{
    public interface IPSIService
    {
        ...
        public Task<IResult> SetTypeHeader(TypeHeader typeHeader, Guid psiTypeHeaderId, Guid psiTypeTimeStampId);
        public Task<IResult> SetTypeTimeStamp(TypeTimeStamp typeTimeStamp, Guid psiTypeTimeStampId);
        ...
        public Task<IResult> SetTypeInputMat(TypeInputMat typeInputMat, Guid psiTypeInputMatId, Guid psiTypeMatId, Guid? psiTypeProcessInstructions = null, Guid? psiProdReportL22PES = null);
        public Task<IResult> SetTypeOutputMatTarget(List<TypeOutputMatTarget> typeOutputMatTargets,  Guid psiTypeMatId, Guid psiTypeIProcessInstructions);
