...
namespace Business.Concrete.PLC
{
    public class PLCRecipeManager : IPLCRecipeService
    {
        ...
        private IPLCRecipeDal _plcRecipeDal;
        public PLCRecipeManager(IPLCDal plcDal, IPLCRecipeDal plcRecipeDal)
        {
            _plcDal = plcDal;
            _plcRecipeDal = plcRecipeDal;
        }

        public async Task<IDataResult<PLCRecipe>> ReadPLCRecipe(int recipeNumber)
        {
            var plcRecipe = await _plcRecipeDal.Get(x => x.RecipeNumber == recipeNumber && x.IsActive == true);
            ...
            plcRecipe.RecipeRecordNumber = (int)_plcDal.Read(DataType.DataBlock, 96, 42, VarType.Int, 1);//TagName:RecipeNumber,TagValue:DB 96 DBW 42
            ...
            plcRecipe.RewinderOneLengthSet = (int)_plcDal.Read(DataType.DataBlock, 91, 386, VarType.Int, 1);//Name:Recipe_entry_0_5 ,DisplayName: Set length rewinder 1  [m] Set diameter rewinder 1 [mm] ,TagName:Rew1LengthSet,TagValue:  DB 91 DBD 306
            ...
            plcRecipe.RewinderTensionLaySetScaled = (int)_plcDal.Read(DataType.DataBlock, 91, 372, VarType.Int, 1);//Name:Recipe_entry_0_8  ,DisplayName:Tension layon roll rewinder 1 [N/mm²],TagName:Rew1TensionLaySetScaled,TagValue:  DB 91 DBW 372
            ...
            plcRecipe.RewinderOnePresLayBalance = (int)_plcDal.Read(DataType.DataBlock, 91, 366, VarType.Int, 1);//Name:Recipe_entry_0_12  ,DisplayName: Balance layon roll rewinder 1 [%],TagName:Rew1PresLayBalance,TagValue: DB 91 DBW 366
            ...
            plcRecipe.RewinderTwoLengthSet = (int)_plcDal.Read(DataType.DataBlock, 91, 406, VarType.Int, 1);//Name:Recipe_entry_0_14  ,DisplayName: Set length rewinder 2 [m],TagName:Rew2LengthSet,TagValue: DB 91 DBD 406
            ...
            plcRecipe.Optime = DateTime.Now;
            
            plcRecipe.IsActive =true ;

            _plcRecipeDal.Update(plcRecipe);

            return new SuccessDataResult<PLCRecipe>(plcRecipe);
        }
